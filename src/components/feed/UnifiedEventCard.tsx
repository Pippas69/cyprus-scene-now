...
export const UnifiedEventCard = ({
  ...
  if (size === "compact" || size === "default" || size === "boosted") {
    ...
    const sizeClasses = {
      ...
      boosted: "min-w-[calc(50vw-6px)] max-w-[calc(50vw-6px)] sm:min-w-[220px] sm:max-w-[220px] lg:min-w-[240px] lg:max-w-[240px]"
    };
    ...
    return (
      ...
      >
        ...
        <div className={cn("relative overflow-visible", size === "boosted" ? "h-28 sm:h-36 lg:h-40" : "h-32 lg:h-40")}>
