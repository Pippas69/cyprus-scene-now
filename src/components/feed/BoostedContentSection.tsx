...
const OfferCard = memo(({ offer, t, language }: OfferCardProps) => {
  ...
  return (
    <>
      ...
      <div
        ref={cardRef as any}
        className="flex flex-col rounded-xl bg-card border border-border [@media(hover:hover)]:hover:border-primary/50 [@media(hover:hover)]:hover:shadow-lg transition-colors duration-200 group min-w-[calc(50vw-10px)] max-w-[calc(50vw-10px)] lg:min-w-[240px] lg:max-w-[240px] overflow-visible"
      >
