...
export const BusinessDirectorySection = ({
  ...
  return <div className="w-full">
      <motion.div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-5 xl:grid-cols-6 gap-2 sm:gap-3" initial={{
      opacity: 0
    }} animate={{
      opacity: 1
    }} transition={{
...
const BusinessCard = ({
  ...
  return <motion.div initial={{
    ...
    }} className="relative aspect-square md:aspect-[5/4] lg:aspect-square rounded-xl overflow-hidden border border-border hover:border-primary/50 hover:shadow-lg transition-all duration-200 group block">
