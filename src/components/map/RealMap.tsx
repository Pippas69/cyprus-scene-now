...
const RealMap = ({ city, neighborhood, selectedCategories, focusBusinessId }: RealMapProps) => {
  ...
  return (
    <div className={`relative w-full rounded-2xl overflow-hidden shadow-xl ring-1 ring-aegean/20 transition-all duration-300 ${
      ...
      <div className="absolute top-2 right-9 md:right-11 z-10">
      ...
      <Button
        size="icon"
        variant="outline"
        className="absolute top-2 right-2 z-10 h-6 w-6 md:h-7 md:w-7 bg-[#0D3B66] border-[#0D3B66] text-white hover:bg-[#0D3B66]/90 hover:text-white shadow-lg"
