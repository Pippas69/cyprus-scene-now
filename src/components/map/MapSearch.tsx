    ...
    <div className="relative">
      <div className="relative">
        ...
        <Input
          ...
          className={cn(
            "pl-5 md:pl-6 lg:pl-8 shadow-lg border-0 rounded-lg",
            "h-[24px] md:h-[26px] lg:h-8",
            "text-[8px] md:text-[9px] lg:text-xs text-white placeholder:text-white/70",
            "w-[90px] md:w-[120px] lg:w-[180px]"
          )}
