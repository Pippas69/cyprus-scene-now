...
export const MapSearch = ({ onResultClick, language }: MapSearchProps) => {
  ...
  return (
    <div className="relative">
      <div className="relative">
        <Search className="absolute left-2 md:left-3 top-1/2 -translate-y-1/2 text-white/60 h-3.5 w-3.5 md:h-4 md:w-4" />
        <Input
          type="text"
          ...
          className={cn(
            ...
            "h-9 md:h-10",
            "text-xs md:text-sm text-white placeholder:text-white/50",
