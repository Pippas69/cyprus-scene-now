...
const FAQItem = ({ 
  ...
  <div 
    className="bg-[#e8f4f4]/80 backdrop-blur-sm rounded-lg sm:rounded-xl overflow-hidden cursor-pointer transition-all duration-300 hover:bg-[#e0f0f0]"
    onClick={onClick}
  >
    <div className="flex items-center justify-between px-3 sm:px-4 md:px-5 py-3 sm:py-4">
      <span className="text-[#1a4a5a] font-medium text-xs sm:text-sm md:text-base pr-2 sm:pr-4 leading-tight">{question}</span>
      <ChevronDown 
        className={`w-4 h-4 sm:w-5 sm:h-5 text-[#2a6a7a] flex-shrink-0 transition-transform duration-300 ${isOpen ? 'rotate-180' : ''}`} 
      />
    </div>
    {isOpen && (
      <motion.div
        ...
        className="px-3 sm:px-4 md:px-5 pb-3 sm:pb-4"
      >
        <p className="text-[#3a7a8a] text-xs sm:text-sm leading-relaxed">{answer}</p>
      </motion.div>
    )}
  </div>
);
      ...
      <div className="container mx-auto px-3 sm:px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 max-w-6xl mx-auto mb-10 sm:mb-12 md:mb-16">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-[#0d3b4a] mb-4 sm:mb-6">{t.userTitle}</h3>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-[#0d3b4a] mb-4 sm:mb-6">{t.businessTitle}</h3>
            <div className="space-y-2 sm:space-y-3">
        ...
        >
          <div className="relative">
            <Heart className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 text-[#2a8a9a] fill-[#2a8a9a]" />
          </div>
          <div className="w-16 sm:w-20 md:w-24 h-1.5 sm:h-2 bg-[#1a5a6a]/30 rounded-full mt-2 overflow-hidden">
            <motion.div 
        ...
        <motion.p
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="text-center text-lg sm:text-xl md:text-2xl lg:text-3xl font-semibold text-[#0d3b4a] mb-6 sm:mb-8 px-2"
        >
          {t.tagline}
        </motion.p>
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="flex flex-row justify-center gap-2 sm:gap-3 md:gap-4"
        >
          {/* App Store Button */}
          <button
            type="button"
            onClick={() => console.log("App Store clicked")}
            className="flex items-center gap-1.5 sm:gap-2 md:gap-3 px-3 sm:px-4 md:px-6 py-2 sm:py-2.5 md:py-3 bg-gradient-to-r from-seafoam to-aegean text-white rounded-lg sm:rounded-xl hover:opacity-90 transition-all duration-300 hover:scale-105 shadow-lg"
          >
            <svg viewBox="0 0 24 24" className="w-5 h-5 sm:w-6 sm:h-6 md:w-7 md:h-7 fill-current flex-shrink-0">
              <path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.81-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M13 3.5c.73-.83 1.94-1.46 2.94-1.5.13 1.17-.34 2.35-1.04 3.19-.69.85-1.83 1.51-2.95 1.42-.15-1.15.41-2.35 1.05-3.11z"/>
            </svg>
            <div className="flex flex-col items-start">
              <span className="text-[7px] sm:text-[8px] md:text-xs opacity-90">Download on the</span>
          ...
          >
            ...
            <div className="flex flex-col items-start">
              <span className="text-[7px] sm:text-[8px] md:text-xs opacity-90">GET IT ON</span>
