  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-background via-background to-seafoam/5">
      ...
      <motion.div
        ...
        className="absolute top-24 sm:top-28 md:top-32 inset-x-0 flex justify-center z-20"
      >
        <span className="inline-flex items-center justify-center px-6 sm:px-8 py-2.5 sm:py-3 rounded-full bg-gradient-to-r from-seafoam/15 to-aegean/15 border border-seafoam/30 shadow-lg">
