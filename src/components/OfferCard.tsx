    ...
    >
      <CardContent className="p-0">
        ...
        <button
          ...
          className="block relative aspect-[3/2] overflow-hidden rounded-t-xl w-full"
        ...
        >
          ...
          <div className="absolute bottom-2 left-2 right-2 flex items-center justify-between z-10">
            ...
            <button
              ...
              className="bg-[hsl(var(--card))] backdrop-blur-md text-white p-1.5 rounded-full border border-white/20 shadow-lg hover:bg-[hsl(var(--card))]/90 transition-all shrink-0"
          ...
          {/* Bundle badge */}
          {isBundle && (
            <div className="absolute left-3 top-3 z-10" style={offerData.requires_reservation ? { top: '2.5rem' } : undefined}>
