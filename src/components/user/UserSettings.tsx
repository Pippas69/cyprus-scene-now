...
export const UserSettings = ({ userId, language }: UserSettingsProps) => {
  ...
  return (
    <div className="space-y-4 sm:space-y-6 max-w-2xl">
          ...
          <form onSubmit={handleProfileUpdate} className="space-y-3 sm:space-y-4">
            ...
            <div className="space-y-1.5 sm:space-y-2">
              ...
              <Input
                ...
                value={profile.email || ''}
                disabled
                className="rounded-xl bg-muted h-9 sm:h-10 text-sm"
              />
            </div>

            <div className="space-y-1.5 sm:space-y-2">
              <Label htmlFor="town" className="flex items-center gap-2 text-xs sm:text-sm">
              ...
              >
                <SelectTrigger id="town" className="rounded-xl h-9 sm:h-10 text-sm">
            ...
            <div className="space-y-1.5 sm:space-y-2">
              ...
              >
                <SelectTrigger id="gender" className="rounded-xl h-9 sm:h-10 text-sm">
            ...
            <div className="space-y-2 sm:space-y-3 pt-3 sm:pt-4 border-t">
              <div>
                ...
                <p className="text-[10px] sm:text-sm text-muted-foreground mt-0.5 sm:mt-1">{t.interestsDescription}</p>
              </div>
            ...
            <Button type="submit" disabled={profileLoading} className="mt-3 sm:mt-4 gap-1.5 sm:gap-2 h-8 sm:h-10 text-xs sm:text-sm px-3 sm:px-4">
      ...
      <Card>
        ...
        <CardContent className="space-y-3 sm:space-y-6">
          ...
          <div className="flex items-center justify-between gap-2">
            <Label className="text-[11px] sm:text-sm leading-tight whitespace-nowrap">{t.emailConfirmationsTitle}</Label>
            <Switch
              checked={true}
              disabled
              className="data-[state=checked]:bg-primary cursor-default scale-[0.8] sm:scale-100"
            />
          </div>
          
          <div className="flex items-center justify-between gap-2">
            <Label className="text-[11px] sm:text-sm leading-tight whitespace-nowrap">
              {language === 'el' ? 'Επιβεβαιώσεις Κρατήσεων, Εισιτηρίων & Προσφορών' : t.confirmationsTitle}
            </Label>
            <Switch
              checked={true}
              disabled
          ...
          {pushSupported && (
            <div className="flex items-center justify-between gap-2">
              <div className="flex items-center gap-1.5 sm:gap-2 min-w-0">
                ...
                <Label className="text-[11px] sm:text-sm leading-tight whitespace-nowrap">{t.pushNotifications}</Label>
              </div>
          ...
          {pushSupported && permissionState === 'denied' && (
            <p className="text-[10px] sm:text-xs text-destructive whitespace-nowrap">{t.pushDenied}</p>
          )}
          ...
          <div className="space-y-2 sm:space-y-4">
            <h4 className="text-[11px] sm:text-sm font-semibold text-muted-foreground flex items-center gap-1.5 sm:gap-2">
              <Sparkles className="h-3 w-3 sm:h-4 sm:w-4 flex-shrink-0" />
              {t.suggestionsForYou}
            </h4>
            <div className="flex items-center justify-between gap-2">
              <Label htmlFor="suggestions-toggle" className="text-[11px] sm:text-sm leading-tight whitespace-nowrap">{t.suggestionsForYou}</Label>
              <Switch
          ...
          <div className="space-y-2 sm:space-y-4">
            ...
            <div className="flex items-center justify-between gap-2">
              <Label htmlFor="event-reminders" className="text-[11px] sm:text-sm leading-tight whitespace-nowrap">
                {language === 'el' ? 'Υπενθυμίσεις Εκδηλώσεων, Κρατήσεων & Προσφορών' : 'Event, Reservation & Offer Reminders'}
              </Label>
              <Switch
                id="event-reminders"
      ...
      <Card>
        ...
        <CardContent className="space-y-3 sm:space-y-4">
          <div className="space-y-1.5 sm:space-y-2">
            ...
            >
              <SelectTrigger id="profile-visibility" className="rounded-xl h-9 sm:h-10 text-sm">
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
      ...
      <Card>
        <CardHeader className="pb-2 sm:pb-4">
          <CardTitle className="flex items-center gap-2 text-sm sm:text-base whitespace-nowrap">
        ...
        <CardContent className="space-y-3 sm:space-y-4">
          <div className="space-y-1.5 sm:space-y-2">
            ...
            >
              <SelectTrigger id="language" className="rounded-xl h-9 sm:h-10 text-sm">
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
          ...
          <div className="space-y-1.5 sm:space-y-2">
            ...
            >
              <SelectTrigger id="theme" className="rounded-xl h-9 sm:h-10 text-sm">
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
