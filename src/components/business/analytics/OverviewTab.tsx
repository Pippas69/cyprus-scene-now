...
const translations = {
  el: {
    ...
    metrics: {
      ...
      customers: "Πελάτες",
      customersExplanation: "Μοναδικά άτομα με QR (ίδιος ορισμός με CRM)",
      customersDetails: "Μετράει μοναδικά άτομα που απέκτησαν QR μέσω εισιτηρίου, κράτησης (προφίλ/προσφορά/εκδήλωση), εξαργύρωσης προσφοράς ή φοιτητικής έκπτωσης.",
      customersSource: "Εισιτήρια + Κρατήσεις + Προσφορές + Φοιτητικά",
      recurring: "Επιστρέφοντες",
      recurringExplanation: "Registered χρήστες με 2+ ενέργειες",
      recurringDetails: "Ποσοστό registered χρηστών που έκαναν 2+ ενέργειες (κρατήσεις/εισιτήρια/προσφορές/φοιτητικά) στο εύρος ημερομηνιών.",
      recurringSource: "Ιστορικό registered χρηστών",
  ...
  en: {
    ...
    metrics: {
      ...
      customers: "Customers",
      customersExplanation: "Unique people with QR (same definition as CRM)",
      customersDetails: "Counts unique people who received a QR via ticket, reservation (profile/offer/event), offer redemption, or student discount redemption.",
      customersSource: "Tickets + Reservations + Offers + Student",
      recurring: "Returning",
      recurringExplanation: "Registered users with 2+ actions",
      recurringDetails: "Percentage of registered users with 2+ actions (reservations/tickets/offers/student) in the selected date range.",
      recurringSource: "Registered user action history",
