...
const translations = {
  el: {
    ...
    metrics: {
      ...
      reservationsDetails: "Όλες οι επιβεβαιωμένες κρατήσεις: απευθείας στο προφίλ, μέσω προσφοράς με κράτηση, ή μέσω εκδήλωσης.",
      ...
      visits: "Επισκέψεις",
      visitsExplanation: "QR check-ins από κρατήσεις + εισιτήρια",
      visitsDetails: "Πραγματικές επισκέψεις που επαληθεύτηκαν με QR scan: σαρώσεις κρατήσεων + check-ins εισιτηρίων.",
      visitsSource: "Σαρώσεις κρατήσεων + check-ins εισιτηρίων",
    },
  },
  en: {
    ...
    metrics: {
      ...
      reservationsDetails: "All confirmed reservations: direct on profile, via offer with reservation, or via event.",
      ...
      visits: "Visits",
      visitsExplanation: "QR check-ins from reservations + tickets",
      visitsDetails: "Real visits verified by QR scan: reservation scans + ticket check-ins.",
      visitsSource: "Reservation scans + ticket check-ins",
    },
  },
};
