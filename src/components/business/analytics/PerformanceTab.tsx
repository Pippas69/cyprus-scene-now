...
const translations = {
  el: {
    ...
    regionNoData: 'Δεν υπάρχουν δεδομένα περιοχής. Όταν πελάτες με συμπληρωμένη πόλη κάνουν κράτηση ή αγοράσουν εισιτήριο, θα εμφανιστούν εδώ.',
    dataSource: 'Πηγή δεδομένων',
    // Views - πόσες φορές είδαν οι χρήστες το περιεχόμενο
    viewsExplanation: 'Πόσες φορές είδαν οι χρήστες',
    profileViewsDetails: 'Πόσες φορές είδαν οι χρήστες τη σελίδα του προφίλ σου, από feed, χάρτη ή αναζήτηση.',
    offersViewsDetails: 'Πόσες φορές είδαν οι χρήστες τις σελίδες των προσφορών σου.',
    eventsViewsDetails: 'Πόσες φορές είδαν οι χρήστες τις σελίδες των εκδηλώσεών σου.',
    profileViewsSource: 'Σελίδα προφίλ, feed, χάρτης',
    offersViewsSource: 'Σελίδες προσφορών',
    eventsViewsSource: 'Σελίδες εκδηλώσεων',
    // Interactions - ενδιαφέρον χρηστών
    interactionsExplanation: 'Ενδιαφέρον χρηστών',
    profileInteractionsDetails: 'Χρήστες που αποθήκευσαν, ακολούθησαν ή μοιράστηκαν το προφίλ σου.',
    ...
    profileInteractionsSource: 'Αποθηκεύσεις, ακολουθήσεις, shares',
    offersInteractionsSource: 'Κλικ στο "Εξαργύρωσε"',
    eventsInteractionsSource: 'RSVPs (Ενδιαφέρομαι/Θα πάω)',
    // Visits - πραγματικές επισκέψεις
    visitsExplanation: 'Επαληθευμένες επισκέψεις',
    profileVisitsDetails: 'QR check-ins από κρατήσεις που έγιναν απευθείας στο προφίλ.',
    offersVisitsDetails: 'Σαρώσεις QR για εξαργύρωση προσφοράς στον χώρο σου.',
    eventsVisitsDetails: 'Check-ins εισιτηρίων και κρατήσεων εκδηλώσεων.',
    profileVisitsSource: 'QR σαρώσεις κρατήσεων',
  ...
  en: {
    ...
    profileViewsDetails: 'How many times users viewed your profile page from feed, map, or search.',
    offersViewsDetails: 'How many times users viewed your offer pages.',
    eventsViewsDetails: 'How many times users viewed your event pages.',
    ...
    profileInteractionsDetails: 'Users who saved, followed, or shared your profile.',
    ...
    profileVisitsDetails: 'QR check-ins from reservations made directly on your profile.',
    offersVisitsDetails: 'QR scans for offer redemption at your venue.',
    eventsVisitsDetails: 'Ticket and event reservation check-ins.',
