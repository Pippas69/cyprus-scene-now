...
const translations = {
  el: {
    ...
    profileVisitsDetails: 'QR check-ins από κρατήσεις που έγιναν απευθείας μέσω του προφίλ σου. Περιλαμβάνει επισκέψεις από φοιτητική έκπτωση (εάν είναι ενεργοποιημένη στις ρυθμίσεις).',
  ...
  en: {
    ...
    profileVisitsDetails: 'QR check-ins from reservations made directly through your profile. Includes visits from student discount (if enabled in settings).',
    ...
    <Dialog>
      ...
      <DialogContent className="max-w-[280px] sm:max-w-md p-3 sm:p-6">
        <DialogHeader className="pb-2 sm:pb-4">
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <div>
              ...
              <DialogDescription className="text-[10px] sm:text-sm">{explanation.explanation}</DialogDescription>
            </div>
          </div>
        </DialogHeader>
        <div className="space-y-2 sm:space-y-4 pt-1 sm:pt-2">
          ...
          <p className="text-[10px] sm:text-sm text-muted-foreground">{explanation.details}</p>
