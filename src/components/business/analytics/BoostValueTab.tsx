        ...
        <div className="space-y-2 sm:space-y-4 pt-1 sm:pt-2">
          <div className="grid grid-cols-2 gap-2 sm:gap-4">
            <div className="p-2 sm:p-4 bg-muted/50 rounded-lg text-center">
              <p className="text-[10px] sm:text-sm text-muted-foreground mb-0.5 sm:mb-1">Χωρίς</p>
              <p className="text-lg sm:text-2xl font-bold text-foreground">{without.toLocaleString()}</p>
            </div>
            <div className="p-2 sm:p-4 bg-primary/10 rounded-lg text-center">
              <p className="text-[10px] sm:text-sm text-muted-foreground mb-0.5 sm:mb-1">Με Boost</p>
              <p className="text-lg sm:text-2xl font-bold text-primary">{withBoost.toLocaleString()}</p>
            </div>
          </div>
