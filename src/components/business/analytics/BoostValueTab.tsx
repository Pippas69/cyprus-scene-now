...
const translations = {
  el: {
    ...
    profileViewsDetails: 'Πόσες φορές είδαν οι χρήστες τη σελίδα του προφίλ σου, από feed, χάρτη ή αναζήτηση. Συγκρίνονται οι προβολές όταν ήταν επιλεγμένο vs μη επιλεγμένο.',
    profileViewsSource: 'Σελίδα προφίλ, feed, χάρτης',
    profileInteractionsExplanation: 'Ενδιαφέρον χρηστών',
    profileInteractionsDetails: 'Χρήστες που αποθήκευσαν, ακολούθησαν ή μοιράστηκαν το προφίλ σου. Συγκρίνονται οι αλληλεπιδράσεις όταν ήταν επιλεγμένο vs μη επιλεγμένο.',
    profileInteractionsSource: 'Αποθηκεύσεις, ακολουθήσεις, shares',
    profileVisitsExplanation: 'Επαληθευμένες επισκέψεις',
    profileVisitsDetails: 'QR check-ins από κρατήσεις που έγιναν απευθείας στο προφίλ. Συγκρίνονται οι επισκέψεις όταν ήταν επιλεγμένο vs μη επιλεγμένο.',
    ...
    offersViewsDetails: 'Πόσες φορές είδαν οι χρήστες τις σελίδες των προσφορών σου. Συγκρίνονται οι προβολές με και χωρίς προβολή.',
    ...
    offersVisitsDetails: 'Σαρώσεις QR για εξαργύρωση προσφοράς στον χώρο σου. Συγκρίνονται οι επισκέψεις με και χωρίς προβολή.',
    ...
    eventsViewsDetails: 'Πόσες φορές είδαν οι χρήστες τις σελίδες των εκδηλώσεών σου. Συγκρίνονται οι προβολές με και χωρίς προβολή.',
    ...
    eventsVisitsDetails: 'Check-ins εισιτηρίων και κρατήσεων εκδηλώσεων. Συγκρίνονται οι επισκέψεις με και χωρίς προβολή.',
