...
const translations = {
  el: {
    ...
    explanations: {
      gender: "Η κατανομή φύλου βασίζεται στα στοιχεία που έχουν δηλώσει οι πελάτες σας κατά την εγγραφή τους στο FOMO.",
      genderDetails: "Το φύλο δηλώνεται κατά την εγγραφή στο FOMO ή μέσω των ρυθμίσεων του χρήστη.",
      age: "Η ανάλυση ηλικίας βασίζεται στα στοιχεία που έχουν δηλώσει οι πελάτες σας.",
      ageDetails: "Η ηλικία δηλώνεται κατά την εγγραφή ή κατά την αγορά εισιτηρίου/κράτηση.",
      region: "Η κατανομή πόλης βασίζεται στα στοιχεία που έχουν δηλώσει οι πελάτες σας.",
      regionDetails: "Η πόλη δηλώνεται κατά την εγγραφή ή κατά την αγορά εισιτηρίου/κράτηση.",
    },
  },
  en: {
    title: "Your Audience",
