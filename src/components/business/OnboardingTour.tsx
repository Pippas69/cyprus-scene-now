...
const translations = {
  el: {
    ...
    step1Feature2: 'Χαμηλότερη προμήθεια (6%)',
    step1Feature3: 'Πλήρη analytics',
    step1Feature4: 'Απεριόριστες εκδηλώσεις',
    step1Bonus: 'Αξίας €239.99/μήνα - Δωρεάν!',
    ...
    step3Feature4: 'Παρακολούθηση real-time',
    step4Title: 'Boost',
  ...
  en: {
    ...
    step1Feature2: 'Lowest commission (6%)',
    step1Feature3: 'Full analytics',
    step1Feature4: 'Unlimited events',
    step1Bonus: 'Worth €239.99/month - Free!',
    step2Title: 'Events',
    ...
    step3Feature4: 'Real-time tracking',
    step4Title: 'Boost',
