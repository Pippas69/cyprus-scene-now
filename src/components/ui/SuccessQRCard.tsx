      ...
      <div className="bg-white dark:bg-white backdrop-blur-xl px-4 py-3">
        ...
        {onViewDashboard && viewDashboardLabel ? (
          <div className="mt-3 space-y-2">
            ...
            <div className="grid grid-cols-[minmax(0,1fr)_auto] items-center gap-1.5 sm:gap-2 min-w-0">
              <div className="flex-1 min-w-0 bg-[#f0f9ff] rounded-lg px-1.5 sm:px-3 py-2 text-[8px] sm:text-[10px] text-[#64748b] font-mono truncate">
              ...
              <Button
                ...
                className="justify-self-end border-[#3ec3b7] text-[#102b4a] bg-white hover:bg-[#3ec3b7]/10 h-8 w-auto px-2 sm:px-3 text-[11px] sm:text-sm gap-1 shrink-0"
              >
          ...
          <div className="mt-2 grid grid-cols-[minmax(0,1fr)_auto] items-center gap-1.5 sm:gap-2 min-w-0">
            <div className="flex-1 min-w-0 bg-[#f0f9ff] rounded-lg px-1.5 sm:px-3 py-2 text-[8px] sm:text-[10px] text-[#64748b] font-mono truncate">
              {`${window.location.origin}/${getViewPath()}/${qrToken}`}
            </div>
            <Button
