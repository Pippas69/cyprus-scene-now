    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-24 pb-16">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          {/* Replace YOUR_TERMLY_PRIVACY_POLICY_ID with your actual Termly document ID */}
          <div
            data-id="YOUR_TERMLY_PRIVACY_POLICY_ID"
            data-type="iframe"
          ...
          <noscript>
            <div className="bg-card rounded-xl p-8 text-center">
              <p className="text-muted-foreground">
                {language === "el"
                  ? "Ενεργοποιήστε το JavaScript για να δείτε την Πολιτική Απορρήτου."
                  : "Please enable JavaScript to view the Privacy Policy."}
              </p>
            </div>
          </noscript>
        </div>
