-- Fix double-counting in get_audience_demographics
-- Exclude offer-linked reservations from the reservations section
...
BEGIN
  ...
  WITH all_visits AS (
    ...
    -- IMPORTANT: Exclude reservations that were created via offers (offer_purchases.reservation_id)
