...
-- RESTORED: ticket demographics from tickets.guest_age / tickets.guest_city
...
-- RESTORED: reservation demographics from reservations.guest_ages / reservations.guest_city
...
-- RESTORED: profile demographics from profiles.age / profiles.city
...
-- Favorite table via reservation_table_assignments → floor_plan_tables
