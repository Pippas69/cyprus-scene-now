...
-- Update search_content to require verified=true for ALL result types (businesses, events, offers)
...
BEGIN
  ...
  WITH all_results AS (
    ...
    -- CRITICAL: Only show verified businesses
    SELECT
    ...
    WHERE
      ...
      AND b.verified = true  -- CRITICAL: Only verified businesses
