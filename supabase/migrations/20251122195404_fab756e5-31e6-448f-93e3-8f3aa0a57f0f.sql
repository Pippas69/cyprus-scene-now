-- Fix column reference bug in get_business_analytics function
...
BEGIN
  ...
  FROM (
    SELECT COUNT(*) as ev_count, user_id as ev_user, NULL::UUID as dv_user, 0 as dv_count
    FROM event_views ev
    ...
    SELECT 0 as ev_count, NULL::UUID as ev_user, user_id as dv_user, COUNT(*) as dv_count
