...
-- 1) Add email column
ALTER TABLE public.reservations ADD COLUMN IF NOT EXISTS email text DEFAULT NULL;

-- 2) Rebuild with reservation no-shows and correct table name
