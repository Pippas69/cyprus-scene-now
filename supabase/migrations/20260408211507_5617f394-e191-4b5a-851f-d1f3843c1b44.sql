...
-- Hybrid spend: distribute reservation spend (min_charge or actual_spend) to ALL ghosts in the party
-- This REPLACES ticket_spend for hybrid events (since min_charge includes ticket credit)
...
-- Reservation spend: EXCLUDE hybrid (auto_created_from_tickets) to avoid double counting
